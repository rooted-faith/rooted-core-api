...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            'requires_tenant', sa.Boolean(), server_default=sa.text('false'), nullable=False, comment='Whether provider_tenant is required on Identity links'
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['preferred_locale_id'], ['public.system_locale.id'], name=op.f('fk_user_profile_preferred_locale_id_system_locale'), ondelete='SET NULL'
        ),
